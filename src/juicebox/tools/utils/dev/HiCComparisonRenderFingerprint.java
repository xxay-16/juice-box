...
public final class HiCComparisonRenderFingerprint {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (MatrixType mode : new MatrixType[]{
                ...
                MatrixType.OEP1, MatrixType.OEP1V2,
                ...
                MatrixType.RATIOP1, MatrixType.RATIOP1V2,
                MatrixType.RATIO0, MatrixType.RATIO0V2,
                MatrixType.RATIO0P1, MatrixType.RATIO0P1V2,
                MatrixType.OERATIO, MatrixType.OERATIOV2,
                MatrixType.OERATIOP1, MatrixType.OERATIOP1V2,
